                  ...
                  return (
                    <>
                      ...
                      <div className="dispShots">
                        {docs.map((u, k) => (
                          <a key={`d${k}`} href={assetUrl(u)} target="_blank" rel="noreferrer">
                            <img src={assetUrl(u)} alt="dispatch document" />
                          </a>
                        ))}
                      </div>
                    </>
                    ...
                    {(v.frontImageUrl || v.backImageUrl || v.materialImages.length > 0) && (
                      <div className="dispShots">
                        {[v.frontImageUrl, v.backImageUrl]
                          ...
                          .map((u, k) => (
                            <a key={`v${k}`} href={assetUrl(u)} target="_blank" rel="noreferrer">
                              <img src={assetUrl(u)} alt="vehicle" />
                            </a>
                          ))}
                        {v.materialImages.map((u, k) => (
                          <a key={`m${k}`} href={assetUrl(u)} target="_blank" rel="noreferrer">
                            <img src={assetUrl(u)} alt="material" />
                          </a>
                        ))}
                      </div>
                    )}
